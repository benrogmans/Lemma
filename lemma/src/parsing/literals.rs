...
/// Parse a decimal number, supporting underscores and commas as digit separators.
/// Examples: 42, 3.14, 1_000_000, 1,000,000, -5.5
    ...
    Decimal::from_str(&clean_number).map_err(|_| {
        LemmaError::Engine(format!(
            "Invalid number: '{}'\n\
             ...
             Note: Use underscores or commas as thousand separators if needed",
            number_str
        ))
    })
}
