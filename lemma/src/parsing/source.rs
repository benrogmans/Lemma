...
mod tests {
    ...
    fn test_get_text_valid() {
        ...
        source_map.insert(
            "test".to_string(),
            ("test.lemma".to_string(), "hello world".to_string()),
        );
        let span = Span {
            start: 0,
            end: 5,
    ...
    fn test_get_text_full_string() {
        ...
        let loc = Source::new("test.lemma", span, "test");
        assert_eq!(
            loc.get_text(&source_map).unwrap(),
    ...
    fn test_get_text_out_of_bounds_start() {
        ...
        source_map.insert(
            "test".to_string(),
            ("test.lemma".to_string(), "hello".to_string()),
        );
        let span = Span {
            start: 10,
            end: 15,
    ...
    fn test_get_text_unicode() {
        ...
        source_map.insert(
            "test".to_string(),
            ("test.lemma".to_string(), "hello 世界".to_string()),
        );
        let span = Span {
            start: 6,
            end: 12,
    ...
    fn test_source_get_text_with_location() {
        ...
        sources.insert(
            "test".to_string(),
            ("test.lemma".to_string(), source.to_string()),
        );
        ...
        assert_eq!(source.get_text(&sources).unwrap(), "42".to_string());
    }
