...
#[test]
fn test_unit_subtract_percentage() -> Result<(), lemma::LoadError> {
...
#[test]
fn test_unit_add_percentage() -> Result<(), lemma::LoadError> {
    let mut engine = Engine::new();
...
#[test]
fn test_various_unit_percentage_operations() -> Result<(), lemma::LoadError> {
    let mut engine = Engine::new();
...
#[test]
fn test_complex_discount_scenario() -> Result<(), lemma::LoadError> {
    let mut engine = Engine::new();
...
#[test]
fn test_percentage_arithmetic() -> Result<(), lemma::LoadError> {
    let mut engine = Engine::new();
...
#[test]
fn test_averaging_percentages() -> Result<(), lemma::LoadError> {
    let mut engine = Engine::new();
